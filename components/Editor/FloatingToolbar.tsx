...
function TBtn({ title, action, icon, isActive, onAction }: TBtnProps) {
  return (
    <button
      title={title}
      onMouseDown={(e) => {
...
export function FloatingToolbar({ focusedBlockId, blocks, sidebarOffset, onAction }: FloatingToolbarProps) {
  ...
  return (
    ...
    >
      ...
      {/* Inline formatting */}
      <TBtn title="Bold (Ctrl+B)" action="bold" icon={<IconBold />} onAction={onAction} />
      <TBtn title="Italic (Ctrl+I)" action="italic" icon={<IconItalic />} onAction={onAction} />
      <TBtn title="Strikethrough" action="strikethrough" icon={<IconStrikethrough />} onAction={onAction} />
      {showExtendedMobileActions && (
        <>
          <TBtn title="Inline Code" action="code" icon={<IconCode />} onAction={onAction} />
          <TBtn title="Link" action="link" icon={<IconLink />} onAction={onAction} />
        </>
      )}
      ...
      {showExtendedMobileActions && (
        <>
          <Divider />
          <TBtn title="Table" action="table" icon={<IconTable />} onAction={onAction} />
          <TBtn title="Image" action="image" icon={<IconImage />} onAction={onAction} />
          <TBtn title="Divider" action="hr" icon={<IconHR />} onAction={onAction} />
        </>
      )}
    </div>
  );
